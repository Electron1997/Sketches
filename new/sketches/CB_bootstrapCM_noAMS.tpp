...
inline void CB_bootstrapCM_noAMS<TKey, TVol, D, W, H>::update(TKey key, TVol volume){
...
template<typename TKey, typename TVol, size_t D, size_t W, uint32_t (*H)(const TKey&, const size_t&)>
TVol CB_bootstrapCM_noAMS<TKey, TVol, D, W, H>::query(TKey key){
    // CM query
    ...
    TVol l0_estimate = l0_estimator.count(), l2_estimate = l2_estimator.l2_estimate() / sqrt(W), var_estimate = l2_estimate / l0_estimate;
