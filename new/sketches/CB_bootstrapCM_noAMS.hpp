#ifndef CB_BOOTSTRAPCM_NOAMS_INCLUDED
#define CB_BOOTSTRAPCM__NOAMS_INCLUDED
...
struct CB_bootstrapCM_noAMS : CB_sketch<TKey, TVol, D, W, H>{
    ...
    CML2_sketch<TKey, TVol, D, W, H> l2_estimator;
...
#include "CB_bootstrapCM_noAMS.tpp"
